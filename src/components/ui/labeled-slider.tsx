...
function LabeledSliderComponent({
    ...
    return (
        <div
            ...
            className={cn(
                "group rounded-xl border p-3 transition-colors duration-150 select-none",
...
function ThumbnailLabeledSliderComponent({
    ...
    return (
        <div
            className={cn(
                "group rounded-xl border border-border p-3 transition-colors duration-150 select-none",
