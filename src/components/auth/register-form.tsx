...
interface RegisterFormProps {
    ...
    onEmailRegister?: (formData: FormData) => Promise<AuthActionResponse | undefined>
...
export function RegisterForm({
    ...
    const handleSubmit = async (formData: FormData) => {
        ...
        setIsLoading(true)
        try {
            if (!onEmailRegister) return
            const result = await onEmailRegister(formData)
            if (result?.error) {
                ...
                {onEmailRegister && (
                    <>
                        ...
                        <p className="text-center text-sm text-muted-foreground">
                            ...
                            <Link href={loginLink} className="font-bold text-primary hover:underline">
                                Sign In
                            </Link>
                        </p>
                    </>
